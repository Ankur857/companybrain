...
- Shift rotation supporting 24/7 orbital pass operations with flexible engineering hours.`,
  ...
  experiences: [
    // Project Alpha Verified Experience (Acme Technologies)
    {
      id: 'e1111111-0000-0000-0000-000000000001',
      tenant_id: SEED_IDS.TENANT_ACME,
      project_id: SEED_IDS.PROJECT_ALPHA,
      related_document_id: 'f1111111-0000-0000-0000-000000000001',
      author_id: SEED_IDS.USER_RAHUL,
      author_name: 'Rahul Sharma',
      title: 'How we solved API timeout issues in high-load order processing',
      problem: 'The payment ingest and checkout endpoints were timing out under peak load when processing requests with payload arrays over 50 items. Database transaction pool exhaustion was causing 504 gateway timeouts.',
      solution: 'We introduced request chunking and pagination on the ingress gateway, added asynchronous queuing via Redis streams for batch writes, and added a composite index on (tenant_id, order_id) in PostgreSQL.',
      additional_context: 'Reduced 99th percentile latency from 3.2s to 110ms. Ensure Redis buffer sizes are monitored during Friday peak surges.',
      status: 'APPROVED',
      rejection_reason: null,
      reviewed_by: SEED_IDS.USER_ADMIN_A,
      reviewed_at: new Date(Date.now() - 5 * 86400000).toISOString(),
      created_at: new Date(Date.now() - 10 * 86400000).toISOString(),
      updated_at: new Date(Date.now() - 5 * 86400000).toISOString(),
    },
    // Project Alpha Pending Experience for Admin Review
    {
      id: 'e1111111-0000-0000-0000-000000000002',
      tenant_id: SEED_IDS.TENANT_ACME,
      project_id: SEED_IDS.PROJECT_ALPHA,
      related_document_id: 'f1111111-0000-0000-0000-000000000002',
      author_id: SEED_IDS.USER_PRIYA,
      author_name: 'Priya Patel',
      title: 'Fixing Docker networking conflict with local Minikube DNS',
      problem: 'New developers running Docker Desktop on macOS encountered DNS resolution failure when attempting to reach the local Minikube cluster services.',
      solution: 'Added a dns-resolve helper in the dev-env script to bind the host 127.0.0.1 port-forward and update /etc/resolver entries automatically during minikube start.',
      additional_context: 'Tested on Docker Desktop 4.28+. Make sure to restart the Docker daemon after running the script.',
      status: 'PENDING',
      rejection_reason: null,
      reviewed_by: null,
      reviewed_at: null,
    ...
    // Project Beta Verified Experience (Nova Finance)
    {
      id: 'e2222222-0000-0000-0000-000000000001',
      tenant_id: SEED_IDS.TENANT_NOVA,
      project_id: SEED_IDS.PROJECT_BETA,
      related_document_id: 'f2222222-0000-0000-0000-000000000001',
      author_id: SEED_IDS.USER_ARJUN,
      author_name: 'Arjun Mehta',
      title: 'Mitigating memory leaks in WebSocket tick feed listeners',
      problem: 'Market tick subscriber sockets were retaining event listeners across reconnects, gradually consuming 4GB RAM within 12 hours.',
      solution: 'Wrapped the WebSocket client with an explicit lifecycle cleanup teardown on disconnect.',
      additional_context: 'Confirmed memory stability across a 72-hour burn-in test.',
      status: 'APPROVED',
      rejection_reason: null,
      reviewed_by: SEED_IDS.USER_ADMIN_B,
