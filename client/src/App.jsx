...
export default function App() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#070a12] flex flex-col items-center justify-center text-slate-300">
  ...
  // Public standalone pages (no dashboard sidebar/header)
  const isPublicStandalone = location.pathname === '/' || location.pathname === '/login';
  ...
  // Internal Dashboard / Platform Application Layout
  return (
